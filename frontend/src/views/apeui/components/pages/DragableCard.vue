<template>
  <div>
    ...
    <el-card shadow="hover" style="margin-bottom: 16px">
      <template #header>
        <div style="display: flex; justify-content: space-between; align-items: center">
          <span style="font-weight: 600; color: #534686">可拖拽排序卡片</span>
          ...
          <div class="drag-card-wrapper">
            <el-card shadow="hover" class="drag-card">
              ...
              <div class="drag-card-body">
                <h4 style="margin: 0 0 4px; font-weight: 600; color: #534686">{{ element.title }}</h4>
    ...
    <el-card shadow="hover">
      <template #header>
        <span style="font-weight: 600; color: #534686">当前排序</span>
      </template>
...
const defaultCards: DragCard[] = [
  { id: 1, title: '计算资源', desc: 'CPU & GPU 集群', icon: Cpu, gradient: 'linear-gradient(135deg, #534686, #7b6fa8)', tag: '运行中', tagType: 'success' },
  { id: 2, title: '监控面板', desc: '实时系统监控', icon: Monitor, gradient: 'linear-gradient(135deg, #3d3270, #534686)', tag: '正常', tagType: 'success' },
  { id: 3, title: '数据分析', desc: '数据趋势分析', icon: DataLine, gradient: 'linear-gradient(135deg, #534686, #9b8fc4)', tag: '处理中', tagType: 'warning' },
  { id: 4, title: '消息中心', desc: '通知与告警', icon: Bell, gradient: 'linear-gradient(135deg, #7b6fa8, #534686)', tag: '3条新', tagType: 'danger' },
  { id: 5, title: '系统设置', desc: '全局配置管理', icon: Setting, gradient: 'linear-gradient(135deg, #4a3f7a, #6b5fa0)', tag: '已配置', tagType: 'info' },
  { id: 6, title: '存储管理', desc: '云端文件存储', icon: Box, gradient: 'linear-gradient(135deg, #534686, #8b7fb8)', tag: '运行中', tagType: 'success' },
]
...
.drag-card:hover {
  ...
  box-shadow: 0 8px 24px rgba(83, 70, 134, 0.15);
}
.drag-card-header {
  display: flex;
